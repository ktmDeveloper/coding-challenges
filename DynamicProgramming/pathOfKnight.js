...
function solveKnight(){
	...
	let xMove = [-2,-2,-1,-1,1,1,2,2] //knight can go these many x boxes
	let yMove = [-1,1,-2,2,-2,2,-1,1] //for each x pos, knight can then go positive or negative of alternate 1 or 2
